    ...
    <div class="container">
        <div class="menu-content">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/web/"><img src="/web/public/images/logo.png" alt=""></a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <div class="i_con">
                    ...
                    <? else: ?>
                        ...
                        . Html::submitButton(
                            'Logout (' . Yii::$app->user->identity->name .')', ['class' => 'btn btn-link logout', 'style'=>'padding-top:10px;']
                        )
                        . Html::endForm() ?>
                    <? endif; ?>
                    </ul>
        ...
        <div class="row">
            <div class="col-md-4">
                <aside class="footer-widget">
                    <div class="about-img"><img src="/web/public/images/logo.png" alt=""></div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center">&copy; 2017 <a href="#"></a> Built with <i
                            class="fa fa-heart"></i> by <a href="#">Vlad Moiseev</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php $this->endBody() ?>
<? $this->registerJsFile('/public/nprogress.js');?>
<?$this->registerCssFile('/public/nprogress.css'); ?>
<script>
 $('body').show();
